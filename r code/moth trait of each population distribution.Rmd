...
spe_agg = df_select[ ,list(count = .N,
                           ...
                           by = c('Coll_date','Coll_data', 'Species')]


spe_agg_select = spe_agg[count >=10] 

write.csv(file = "E:/structure-equation-model-of-moth/result/csv/spe_agg_select.csv", spe_agg_select, row.names = FALSE)
